    ...
    for feed_id, items in feeds_map.items():
        ...
        for item in items:
            ...
            if url:
                ...
                if published_at:
                    html += f' <span style="font-size: 11px; color: #9ca3af; margin-left: 5px;">🕒 {html_escape(published_at)}</span>'
            else:
                html += escaped_title
                if published_at:
                    html += f' <span style="font-size: 11px; color: #9ca3af; margin-left: 5px;">🕒 {html_escape(published_at)}</span>'
    ...
    html += """
            ...
            <div class="footer">
                <div class="footer-content">
                    ...
                    <a href="https://github.com/AIYXDATA/TrendRadar" target="_blank" class="footer-link">
                        GitHub 开源项目
                    </a>
                </div>
            </div>
