...
from aiyxdata_tradar.core.analyzer import calculate_news_weight as _calculate_news_weight
...
def calculate_news_weight(news_data: Dict, rank_threshold: int = 5) -> float:
    ...
    复用 aiyxdata_tradar.core.analyzer.calculate_news_weight 实现，
